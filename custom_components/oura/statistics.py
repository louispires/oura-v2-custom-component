...
STATISTICS_METADATA = {
    ...
    "met_min_high": {"name": "High Activity MET Minutes", "unit": "MET⋅min", "has_mean": False, "has_sum": True},
    "met_min_medium": {"name": "Medium Activity MET Minutes", "unit": "MET⋅min", "has_mean": False, "has_sum": True},
    "met_min_low": {"name": "Low Activity MET Minutes", "unit": "MET⋅min", "has_mean": False, "has_sum": True},
